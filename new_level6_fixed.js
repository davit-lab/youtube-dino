  ...
  levels.push({
    ...
    jumpboxes: [
      ...
      rect(10100, GROUND_Y - 960, 40, 40, {type: 'coin'}),
      rect(10200, GROUND_Y - 960, 40, 40, {type: 'rage'})
    ],
    barrelSpawners: [
      { x: 5500, y: GROUND_Y - 570 },
      { x: 12500, y: GROUND_Y - 1100 }
    ],
    boulders: [
      { x: 5500, startX: 5500, minX: 4450, y: GROUND_Y - 570, r: 18, vx: -2.5, angle: 0 },
      { x: 12500, startX: 12500, minX: 11500, y: GROUND_Y - 1100, r: 24, vx: -3.5, angle: 0 }
    ],
    spinners: [
    ...
    birds: [
      ...
      { x: 11800, y: GROUND_Y - 1300, w: 56, h: 52, vx: 4, vy: 0, speed: 4, rangeX: 500, startX: 11800, startY: GROUND_Y - 1300, type: 'fire_hawk', state: 'patrol', flapTimer: 0, swoopCooldown: 0 },
      { x: 12400, y: GROUND_Y - 1300, w: 56, h: 52, vx: -4, vy: 0, speed: 4, rangeX: 500, startX: 12400, startY: GROUND_Y - 1300, type: 'fire_hawk', state: 'patrol', flapTimer: 0, swoopCooldown: 0 }
    ],
    zombies: [
      { x: 1400, y: GROUND_Y - 54, type: 'fast' },
      { x: 2350, y: GROUND_Y - 134, type: 'ranged' },
      ...
      { x: 8800, y: GROUND_Y - 894, type: 'fast' },
      { x: 10100, y: GROUND_Y - 894, type: 'tank' },
      { x: 11800, y: GROUND_Y - 1134, type: 'mutant' },
      { x: 12200, y: GROUND_Y - 1134, type: 'boss' },
      { x: 12700, y: GROUND_Y - 1134, type: 'elite' },
      { x: 13200, y: GROUND_Y - 1134, type: 'mutant' }
    ],
    coins: [
      ...
      rect(12500, GROUND_Y - 1180, 22, 22, {isTrap: true}), // Cursed coin!
      rect(12900, GROUND_Y - 1150, 22, 22)
    ],
    signs: [
      ...
      { x: 9900, y: GROUND_Y - 900, text: '💀 ფინალური არენა! მოემზადე უდიდესი ბრძოლისთვის!' }
    ],
    flag: rect(13500, GROUND_Y - 1620, 30, 140, { isFireFlame: true })
  });
